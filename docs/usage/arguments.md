...
| rms_norm_implementation | `str` | `"liger_kernel"` | RMSNorm. Known values: `liger_kernel` (default, GPU), `musa` (MUSA-native fused), `npu`, `triton` (DeepSeek-V3 only; GPU only), `eager`. |
