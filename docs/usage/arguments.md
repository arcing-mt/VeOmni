...
| moe_shared_expert_overlap | `bool` | `false` | Qwen3.5-only experimental side-stream scheduling for the independent shared expert; requires `moe_dispatcher="deepep_ace"` and must be validated with a trace. |
