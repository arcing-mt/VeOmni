...
#    - method_override: Qwen2_5OmniThinkerForConditionalGeneration.get_image_features
#      Return flat image_embeds tensor (skip per-image torch.split)
#    - method_override: Qwen2_5OmniThinkerForConditionalGeneration.get_video_features
#      Return flat video_embeds tensor (skip per-video torch.split)
